    ...
    return (
        <div className="mx-5 my-7 font-inter">
            <div className="flex gap-4 ">
                ...
                <h1 className="text-3xl  font-inter font-bold">Crew Management</h1>
                <button className="flex bg-sky-500  rounded-xl p-2 gap-2 ml-auto px-3 hover:bg-sky-700 transition duration-300">
                    ...
                    <span className="text-md font-inter">Add Crew</span>
                </button>
            </div>


            <div className="flex gap-40 mt-10 border-2">


                <div className=" bg-[rgb(9,16,34)] w-full border border-slate-800 rounded-2xl p-3">
                ...
                <div className="Flex-1">
                    <h1 className="p-3 border">Assignment Cart</h1>
